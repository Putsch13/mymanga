...
import type { ChapterCreativeControls, ChapterStudioData } from "@manga-ai-studio/core";
...
export function ChapterBriefStep({
  ...
  hideIntentCompilePanel?: boolean;
}) {
  return (
    <div data-studio-section="story" className="space-y-6">
      ...
      {!hideIntentCompilePanel && chapterNumber === 1 && projectId && chapterId ? (
