    ...
    <Card className="border-sky-500/25 bg-card/50" data-testid="chapter-locations-wizard-panel">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Définis un décor principal et des lieux secondaires. Le contrat monde visuel
      ...
      <CardContent className="space-y-4">
        ...
        {canons.length > 0 ? (
          <p className="text-[11px] text-emerald-600 dark:text-emerald-400">
            {canons.length} lieu(x) renseigné(s) — synchronisation automatique vers le contrat monde visuel.
          </p>
        ) : (
          <p className="text-[11px] text-muted-foreground">Aucun décor défini.</p>
        )}
