...
export const WIZARD_STEP_NAV: Record<ChapterWizardStepId, WizardStepNavTarget> = {
  intent: { flowStep: "story", studioStep: "intent", scrollFieldId: "studio-short-pitch" },
  hero: { flowStep: "characters", studioStep: "characters", scrollFieldId: "studio-wizard-hero-panel" },
  cast: { flowStep: "characters", studioStep: "characters", scrollFieldId: "studio-wizard-secondary-cast" },
  decor: { flowStep: "locations", studioStep: "canon", scrollFieldId: "studio-location" },
  living_world: { flowStep: "living_world", studioStep: "canon", scrollFieldId: "studio-wizard-living-world" },
  style: { flowStep: "living_world", studioStep: "canon", scrollFieldId: "studio-wizard-visual-style" },
  plan: { flowStep: "plan", studioStep: "production_plan", scrollFieldId: "studio-plan-contract-overview" },
  dialogues: { flowStep: "dialogues", studioStep: "production_plan", scrollFieldId: "studio-chapter-dialogues" },
  readiness: {
...
export function studioStepToWizardStepId(
  ...
  if (
    (flow === "characters" || flow === "locations" || flow === "living_world")
    && pinned
