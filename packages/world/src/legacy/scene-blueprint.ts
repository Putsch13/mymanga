...
function syntheticProceduralEntity(
 ...
 */
function buildSceneBlueprintNarrativeFirst(input: SceneBlueprintInput): SceneBlueprint {
  ...
  const filteredNpcs = toSelection(npcEntities.length > 0 ? npcEntities : [
    syntheticProceduralEntity("npc", "figurants", "narrative-npc-crowd", ["foule"], ["présence de foule"]),
  ]);
