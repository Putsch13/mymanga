...
export function mergeSpeechAndVoiceProfile(sources: CharacterSpeechSources): MergedSpeechProfile {
  ...
  return {
    register: pickStr(sources.voiceRegister, sp.register),
    sentenceLength: pickStr(sources.voiceSentenceLength, sp.sentenceLength),
    vocabularyStyle: pickStr(sources.voiceVocabularyStyle, sp.vocabularyStyle),
    ...
    favoriteExpressions: arrayOfStrings(sources.voiceFavoriteExpressions, sp.favoriteExpressions),
    forbiddenExpressions: arrayOfStrings(sources.voiceForbiddenExpressions, sp.forbiddenExpressions),
