...
export async function runVisualWorldAndNpcGroups(
  ...
  const discoveryInput = {
    ...
    era:
      typeof (input.chapterIntentContract as { era?: unknown } | null)?.era === "string"
        ? (input.chapterIntentContract as { era: string }).era
        : null,
    setting:
      typeof (input.chapterIntentContract as { setting?: unknown } | null)?.setting === "string"
        ? (input.chapterIntentContract as { setting: string }).setting
        : null,
