...
export async function runStoryboardPass(
  ...
  // mécanique qui est l'une des causes racines des chapitres "portraits en
  // boucle / combat-poster / cutaway manquants". En premium, on refuse de
  // s'exécuter sans LLM réel.
