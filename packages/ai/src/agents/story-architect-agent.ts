...
export interface StoryArchitectInput {
  ...
  /**
   * Époque temporelle + cadre du chapitre (depuis `ChapterIntentContract`).
   * Ancre décors, costumes et props : un beat médiéval ne propose pas un
   * gratte-ciel, un cadre "station orbitale" exclut les tavernes en bois.
   */
  era?: string | null;
  setting?: string | null;
  /**
