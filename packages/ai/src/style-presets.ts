...
export const STYLE_PRESETS: Record<StylePresetSlug, StylePresetDefinition> = {
  ...
  seinen_gritty: {
    slug: "seinen_gritty",
    label: "Seinen âpre",
    description: "Traits grenus, ambiance adulte, violence contenue, décors urbains réalistes.",
    tags: ["seinen", "mature", "realistic"],
    visualStyle:
      "gritty seinen manga art, heavy inked linework, realistic anatomy, grainy ink textures, mature storytelling composition",
    stylePackHints: {
      renderFamily: "manga",
      lineWeight: "thick",
      shadingMode: "ink_bw",
    ...
    positiveTerms: ["grainy ink", "mature realism", "urban density", "heavy shadows", "lived-in textures"],
    negativeTerms: ["chibi", "cute", "sparkle", "saturated cartoon colors"],
  },
  seinen_noir: {
    slug: "seinen_noir",
    label: "Noir (polar)",
    ...
    visualStyle:
      "noir detective manga, high-contrast chiaroscuro, heavy black spotting, rain-soaked atmosphere, cinematic low-key lighting",
    stylePackHints: {
      renderFamily: "manga",
      lineWeight: "thick",
      shadingMode: "ink_bw",
    ...
    negativeTerms: ["pastel", "cartoon", "chibi", "saturated", "sparkle"],
  },
  cyberpunk_neon: {
    slug: "cyberpunk_neon",
    ...
    visualStyle:
      "cyberpunk manga art, neon-lit megacity, holographic hud accents, rain reflections, tech-noir atmosphere, heavy inking",
    stylePackHints: {
      renderFamily: "manga",
      lineWeight: "medium",
      shadingMode: "ink_bw",
    ...
    negativeTerms: ["medieval", "rural", "pastoral", "chibi"],
  },
  post_apocalyptic: {
  ...
  mecha_industrial: {
    ...
    visualStyle:
      "mecha industrial manga art, detailed robot mechanical designs, heavy machinery hangars, metallic lighting, panel-line heavy inking",
    stylePackHints: {
      renderFamily: "manga",
      lineWeight: "thick",
      shadingMode: "ink_bw",
    ...
    negativeTerms: ["organic soft", "chibi", "pastel"],
  },
  slice_of_life: {
    slug: "slice_of_life",
  ...
  horror_body: {
    ...
    description: "Horreur graphique, encrage dense, anatomies déformées, ambiances malsaines.",
    tags: ["horror", "seinen", "mature"],
    visualStyle:
      "horror body-horror manga art, dense ink hatching, distorted anatomy, unsettling atmospheric shadows, gritty textures",
    stylePackHints: {
      renderFamily: "manga",
      lineWeight: "thick",
      shadingMode: "ink_bw",
    ...
    negativeTerms: ["cute", "chibi", "sparkle", "romance comedy"],
  },
  sports_dynamic: {
    slug: "sports_dynamic",
