...
> Généré le: 2026-06-18T13:22:02.382Z

## Résumé

- Total routes: 68
- Routes qui écrivent Chapter: 20
- Routes qui écrivent SceneImage: 6
- Routes qui créent Job: 1
- Routes qui lancent Inngest: 0
- Routes qui appellent FAL: 5
- Routes qui modifient approvedOutline: 7
- Routes qui modifient productionPlan: 10
...
| `/api/projects/[id]/chapters/[chapterId]/dialogue-draft` | POST | ✅ | ❌ | ❌ | ❌ | **audit** |
| `/api/projects/[id]/chapters/[chapterId]/intent-compile` | POST | ✅ | ❌ | ❌ | ❌ | **audit** |
...
| `/api/projects/[id]/chapters/[chapterId]/review-queue` | GET, POST | ✅ | ✅ | ❌ | ❌ | **audit** |
...
| `/api/projects/[id]/locations/[locationId]` | PATCH | ✅ | ❌ | ❌ | ❌ | **audit** |
...
### `/api/characters/[characterId]/generate-dna`
...
### `/api/internal/premium-plan-audit/[chapterId]`
...
### `/api/projects/[id]/chapters/[chapterId]/dialogue-draft`
...
### `/api/projects/[id]/chapters/[chapterId]/intent-compile`
...
### `/api/projects/[id]/chapters/[chapterId]/interview`
...
### `/api/projects/[id]/chapters/[chapterId]/review-queue`
...
### `/api/projects/[id]/locations/[locationId]`
...
### `/api/projects/[id]/world/npc-groups/[groupId]`
...
### `/api/projects/[id]/world/npc-groups`
...
### `/api/projects/[id]/world/props/[propId]`
